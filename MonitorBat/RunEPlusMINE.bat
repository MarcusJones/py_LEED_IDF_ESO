...
:                  "nolimit" if unlimited (used when calling readVarsESO)
 ...
 : MY CODE HERE!!!!
 :::::::::::::::::::::::::::::::::::::::
 set program_path=D:\apps\EnergyPlusV7-1-0\
 :::::::::::::::::::::::::::::::::::::::
...
if not exist in.idf copy "%input_path%%~1" In.idf
...
:  4. Test for weather file parameter and copy to working directory
 if "%2" == ""  goto exe
 if EXIST "%weather_path%%2" copy "%weather_path%%2" in.epw
 if EXIST "%weather_path%%2"  copy "%weather_path%%2" in.stat
...
:exe
 ...
 echo Input File  : %input_path%%~1
 echo Output Files: %output_path%
 echo IDD file    : %program_path%Energy+.idd
 if NOT "%2" == "" echo Weather File: %weather_path%%2
 if %pausing%==Y pause
